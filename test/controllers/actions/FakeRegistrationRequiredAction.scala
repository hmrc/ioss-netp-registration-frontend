...
case class FakeRegistrationRequiredActionImpl(
                                               dataToReturn: Option[UserAnswers],
                                               iossNumber: String,
                                               registrationWrapper: RegistrationWrapper
                                             ) extends RegistrationRequiredActionImpl()(ExecutionContext.Implicits.global) {
...
class FakeRegistrationRequiredAction(
                                      dataToReturn: Option[UserAnswers],
                                      iossNumber: String,
                                      registrationWrapper: RegistrationWrapper
                                    ) extends RegistrationRequiredAction()(ExecutionContext.Implicits.global) {

  override def apply(): RegistrationRequiredActionImpl = {
    FakeRegistrationRequiredActionImpl(dataToReturn, iossNumber, registrationWrapper)
  }
}
