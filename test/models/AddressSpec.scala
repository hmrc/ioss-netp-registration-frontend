  ...
  "Address" - {
    ...
    "must serialise / deserialise from and to a International address" - {
      ...
      "with all optional fields present" in {
        ...
        val address: Address = InternationalAddress(
          "line 1",
          Some("line 2"),
          "town or city",
          Some("state or region"),
          Some("post code"),
          Some(Country("DE", "Germany")))
      ...
      "with all optional fields missing" in {
        ...
        val address: Address = InternationalAddress("line 1", None, "town or city", None, None, Some(Country("FR", "France")))
