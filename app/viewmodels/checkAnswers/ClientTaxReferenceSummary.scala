...
import pages.{CheckAnswersPage, ClientTaxReferencePage, Waypoints}
...
object ClientTaxReferenceSummary {
  ...
  def row(
    ...
    answers.get(ClientTaxReferencePage).map { answer =>

      SummaryListRowViewModel(
        key = messages("clientTaxReference.checkYourAnswersLabel", answer),
